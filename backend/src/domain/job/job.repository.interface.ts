...
export const ACTIVE_JOB_STATUSES = ['CLONING', 'ANALYZING', 'GENERATING', 'PUSHING'] as const;
...
export interface IJobRepository {
  ...
  findActiveByRepository(repositoryUrl: string, excludeJobId: string): Promise<ImprovementJob | null>;
}
